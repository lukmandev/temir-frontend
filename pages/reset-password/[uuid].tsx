                    ...
                    >
                        {(formik) => (
                            <form onSubmit={formik.handleSubmit} className={styles.form}>
                                ...
                                <BaseInput name="password" id="password" label="New Password" placeholder={`Enter your ${UserModel.password.min} characters Password`} />
                                <BaseInput name="password_confirmation" id="password_confirmation" label="Confirm new password" placeholder="Confirm your new password" />
